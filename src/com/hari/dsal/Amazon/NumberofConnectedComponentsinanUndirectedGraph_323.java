...
public class NumberofConnectedComponentsinanUndirectedGraph_323 {
	...
	public static void main(String[] args) {
		int[][] grid = { { 0, 1 }, { 1, 2 }, { 3, 4 } };
		NumberofConnectedComponentsinanUndirectedGraph_323 ncs = new NumberofConnectedComponentsinanUndirectedGraph_323();
		System.out.println(ncs.countComponents(5, grid));
	}
}
