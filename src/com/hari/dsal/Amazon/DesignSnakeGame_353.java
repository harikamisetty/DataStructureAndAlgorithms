...
public class DesignSnakeGame_353 {
	...
	public static void main(String[] args) {
		...
		int[][] food = { { 1, 2 }, { 0, 1 } };
		DesignSnakeGame_353 ds = new DesignSnakeGame_353(width, height, food);
		System.out.println(ds.move("R"));
		System.out.println(ds.move("D"));
		System.out.println(ds.move("R"));
		System.out.println(ds.move("U"));
		System.out.println(ds.move("L"));
		System.out.println(ds.move("U"));
	}
}
