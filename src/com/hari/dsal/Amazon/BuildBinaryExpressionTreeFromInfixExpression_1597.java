...
public class BuildBinaryExpressionTreeFromInfixExpression_1597 {
	...
	public static void main(String[] args) {
		BuildBinaryExpressionTreeFromInfixExpression_1597 bb = new BuildBinaryExpressionTreeFromInfixExpression_1597();
		String s = "3*4-2*5";
		bb.expTree(s);
	}
